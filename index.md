...
- Yue Wei, Xianlin Zeng, Hao Fang*, Yulong Ding, and Shuxin Ding,  Generalized Nash equilibrium seeking for directed nonsmooth multi-cluster games via a distributed Lipschitz algorithm,  IEEE Transactions on Control of Network Systems, accepted.
- Yue Wei, Hao Fang*, Xianlin Zeng, and Yulong Ding, A Proximal Algorithm for Distributed Optimization with Nonsmooth Inequality Constraints, IEEE Transactions on Circuits and Systems II: Express Briefs, accepted
